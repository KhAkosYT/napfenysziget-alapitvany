    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="alapitvanyNav">
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 nap-nav-links">
                <li class="nav-item">
                    <a class="nav-link px-3" href="rolunk.html">Rólunk</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-3" href="">Programok</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-3" href="hirek.html">Hírek</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-3" href="kapcsolat.html">Kapcsolat</a>
                </li>
            </ul>
            ...
            <div class="col-md-6 text-center text-md-end">
                <ul class="list-inline mb-0 nap-footer-bottom-links">
                    ...
                    <li class="list-inline-item">
                        <a href="oldalterkep.html"><small>Oldaltérkép</small></a>
                    </li>
                </ul>
            </div>
        </div>
