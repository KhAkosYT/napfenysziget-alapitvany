...
class AlapitoOkirat extends HTMLElement{
    connectedCallback(){
        this.innerHTML = `<a href="./docs/Napfeny_alapito_okirat.pdf" download>Alapító okirat letöltése</a>`;
    }
}
//<alapitvany-alapito-okirat></alapitvany-alapito-okirat>
customElements.define('alapitvany-alapito-okirat', AlapitoOkirat);
