    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="alapitvanyNav">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 nap-nav-links">
                <li class="nav-item"><a class="nav-link px-3" href="index">Főoldal</a></li>
                <li class="nav-item"><a class="nav-link px-3" href="rolunk">Rólunk</a></li>
                <li class="nav-item"><a class="nav-link px-3" href="programok">Programok</a></li>
                <li class="nav-item"><a class="nav-link px-3" href="hirek">Hírek</a></li>
                <li class="nav-item"><a class="nav-link px-3" href="kapcsolat">Kapcsolat</a></li>
            </ul>
            <div class="d-flex mt-3 mt-lg-0">
                <a href="tamogatas" class="nap-btn nap-btn-primary w-100 text-center">ADOMÁNYOZOK</a>
            </div>
        </div>
    </div>
</nav>
    ...
    <div class="container">
        <div class="row gy-4 text-start">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a href="tamogatas" class="nap-btn nap-btn-primary w-100 text-center mt-2">MOST ADOMÁNYOZOK</a>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled nap-footer-links">
                    <li class="mb-2"><a href="rolunk">Rólunk</a></li>
                    <li class="mb-2"><a href="programok">Programok</a></li>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center text-md-end">
                <ul class="list-inline mb-0 nap-footer-bottom-links">
                    <li class="list-inline-item me-3"><a href="impresszum"><small>Impresszum</small></a></li>
                    <li class="list-inline-item"><a href="oldalterkep"><small>Oldaltérkép</small></a></li>
                </ul>
            </div>
        </div>
    </div>
...
function setActiveNavLink() {
    ...
    navLinks.forEach(link => {
        ...
        // A link href attribútumát is ugyanígy normalizáljuk
        const normalizedHref = href.split('/').pop().replace(/\.html$/, '') || 'index';
